      ...
      return (
        <View style={styles.page}>
          ...
          <View style={{ marginTop: 'auto', marginBottom: "35%" }}>
            <H1Text label={i18n.t('dashboard.investment_guide_header.' + index)} style={{ fontSize: 25, textAlign: "center" }} />
            <PText label={i18n.t('dashboard.investment_guide_text.' + index)} style={{ fontSize: 15, marginTop: 20, textAlign: "center" }} />
          </View>
        </View>
      );
    });
