...
export const SubmitButton: FunctionComponent<SubmitButtonProps> = ({ title, handler, ButtonTheme }) => {
  ...
  const WhiteBtn = styled.TouchableOpacity`
    ...
    border: 1px solid ${props => props.BtnTheme == "WhiteTheme" ? '#3679B5' : '#FFFFFF'};
    background-color: ${props => props.BtnTheme == "WhiteTheme" ? '#FFFFFF' : '#2c6190'};
  `;
  const WhiteBtnText = styled.Text`
    ...
    color: ${props => props.BtnTheme == "WhiteTheme" ? '#000000' : '#FFFFFF'};
  `;
  return (
